...
public class DevelopersdatabseApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(DevelopersdatabseApplication.class, args);
    }

    @Override
    public void run(String... args) throws Exception {
        List<Developer> developers1= developerRepository.findAll();
        if(developers1.size()<1) {
